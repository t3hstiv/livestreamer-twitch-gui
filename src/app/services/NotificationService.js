...
import download from "utils/fs/download";
import clearfolder from "utils/fs/clearfolder";
import PATH from "commonjs!path";
import OS from "commonjs!os";


var { alias, and, notEmpty } = computed;
		...
		store.query( "twitchStreamsFollowed", {
			...
			.then(function() {
				...
				var interval = get( this, "interval" ) || 60000,
				    next     = later( this, this.check, interval );
				set( this, "_next", next );
				set( this, "tries", 0 );
			}.bind( this ) )
			...
			.catch(function() {
				...
				if ( ++tries > max ) {
					...
					var next = later( this, this.check, 1000 );
					set( this, "_next", next );
